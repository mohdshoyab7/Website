...
const profile = {
    name: 'Mohd Shoyab',
    title: 'Full-Stack Developer | Specialised in React and React Native | Problem Solver',
    skills: [
        'React', 'React Native','NextJS', 'Redux', 'Express',
        'MySQL', 'MongoDB', 'Docker', 'AWS', 'TypeScript',
        'GraphQL', 'Git', 'Linux', 'BitBucket','GitHub
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
  ...
  React & React Native Developer ⚛️ | Skilled in building scalable mobile and web apps with Node.js backend 🚀 | Passionate about clean architecture and modern UI/UX ✨
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://www.linkedin.com/in/mohd-shoyab-75703b252/?trk=public-profile-join-page"
